...
class Labora6(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "Labora6" # TODO make this more human readable by adding spaces
...
class Labora6Widget(ScriptedLoadableModuleWidget):
...
class Labora6Logic(ScriptedLoadableModuleLogic):
  ...
  def run(self, inputVolume, outputVolume, imageThreshold, enableScreenshots=0, operationType=1):
    ...
    if enableScreenshots:
      self.takeScreenshot('Labora6Test-Start','MyScreenshot',-1)
...
class Labora6Test(ScriptedLoadableModuleTest):
  """
